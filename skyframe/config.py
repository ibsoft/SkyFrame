...
class Config:
    ...
    AVATAR_SIZE = (400, 400)
    FEED_PAGE_SIZE = 50
    FEED_FRESH_DAYS = int(os.getenv("FEED_FRESH_DAYS", "0"))
    FEED_SEEN_ENABLED = os.getenv("FEED_SEEN_ENABLED", "True").lower() in ("1", "False", "yes")
    ...
    APP_VERSION = os.getenv("APP_VERSION", "v_7.3.10")
